...
{
    public class SQLCreaterMySQL:IST.DB.SQLCreater.ASQLCreater
    {
        ...
        public override ASQLCreater Insert(IST.DB.RecordBase rc)
        {
            try
            {
        ...
        public override ASQLCreater Delete(IST.DB.RecordBase rc)
        {
            try
            {
