            ...
            me.items = [Ext.create('Ext.form.Panel', {
                ...
                items: [{
                    ...
                    },
                    {
                        ...
                        fieldLabel: 'UUID',
                        name: 'UUID',
                        id: 'Ext_AppMenuForm_Form_UUID'
                    }, {
                        xtype: 'hidden',
                        fieldLabel: 'APPLICATION_HEAD_UUID',
                        name: 'APPLICATION_HEAD_UUID',
                        id: 'Ext_AppMenuForm_Form_APPLICATION_HEAD_UUID'
                    }
                ],
                fbar: [{
                    type: 'button',
                    ...
                    formBind: true,
                    handler: function() {
                        var form = Ext.getCmp('Ext_AppMenuForm_Form').getForm();
                            ...
                            handler: function() {
                                if (WinProxyPicker == undefined) {
                                    ...
                                    WinProxyPicker.on('selectedEvent', function(obj, jsonObj) {
                                        var appUuid = Ext.getCmp('Ext_AppMenuForm_Form_APPLICATION_HEAD_UUID').getValue();
                                        var menUuid = Ext.getCmp('Ext_AppMenuForm_Form_UUID').getValue();
                                ...
                                WinProxyPicker.applicationHeadUuid = Ext.getCmp('Ext_AppMenuForm_Form_APPLICATION_HEAD_UUID').getValue();
                                WinProxyPicker.menuUuid = Ext.getCmp('Ext_AppMenuForm_Form_UUID').getValue();
                                WinProxyPicker.show();
                                if (appMenuForm) {
                                    appMenuForm.mask();
                                }
        ...
        listeners: {
            'show': function() {
                myMask = new Ext.LoadMask(
                    Ext.getCmp('Ext_AppMenuForm_Form'), {
                        msg: "資料載入中，請稍等...",
                        store: this.storeMenu,
                        removeMask: true
                    });
                ...
                if (this.uuid != undefined) {
                    Ext.getCmp('ExtAppMenuForm_delete').setDisabled(true);

                    Ext.getCmp('Ext_AppMenuForm_Form').getForm().load({
                        params: {
                            'pUuid': Ext.getCmp('ExtAppMenuForm').uuid
                        },
                        success: function(response, a, b) {
                            var _gridProxy = Ext.getCmp('Ext_AppMenuForm_Form').up('window').down("#gridProxy");
                            _gridProxy.store.getProxy().setExtraParam('pApplicationHeadUuid', Ext.getCmp('Ext_AppMenuForm_Form_APPLICATION_HEAD_UUID').getValue());
                            _gridProxy.store.getProxy().setExtraParam('pAppmenuUuid', Ext.getCmp('Ext_AppMenuForm_Form_UUID').getValue());
                    ...
                    /*When 新增資料*/
                    /*取得公司資訊*/
                    Ext.getCmp('Ext_AppMenuForm_Form').getForm().reset();
                    Ext.getCmp('ExtAppMenuForm_delete').setDisabled(true);
                    Ext.getCmp('Ext_AppMenuForm_Form_APPMENU_UUID').setValue(this.parentUuid);
                    Ext.getCmp('Ext_AppMenuForm_Form_APPLICATION_HEAD_UUID').setValue(this.applicationHeadUuid);
                    Ext.getCmp('Ext_AppMenuForm_Form_UUID').setValue('');
                }
            },
            'hide': function() {
                Ext.getBody().unmask();
