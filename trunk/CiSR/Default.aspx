<%@ Page Title="" Language="C#" MasterPageFile="~/mpStand.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="CISR.Default" EnableViewState="false"  %>
...
Ext.onReady(function () {    
    ...
    ExtLogon = Ext.widget({
        ...
        xtype: 'form',
        layout: 'form',        
        url: '<%= Page.ResolveUrl(CISR.Parameter.Config.ParemterConfigs.GetConfig().NoPermissionPage) %>',
        urlSuccess: '',
        urlFail: '',
        frame: true,
    ...
    ExtLogon.width = "100%";
    ExtLogon.urlSuccess = '<%= Page.ResolveUrl(CISR.Parameter.Config.ParemterConfigs.GetConfig().DefaultPage)%>';
    ExtLogon.urlFail = '<%= Page.ResolveUrl(CISR.Parameter.Config.ParemterConfigs.GetConfig().NoPermissionPage)%>';
    ExtLogon.title = '<img src="' + SYSTEM_ROOT_PATH + '/css/custimages/login.gif" style="height:16px;margin-bottom:4px;margin-right:10px;" align="middle"><%= CISR.Parameter.Config.ParemterConfigs.GetConfig().SystemName%>';
