...
namespace CISR.Controller.Model.Basic
{
    public partial class BasicModel
    {
        ...
        public IList<Attendant_Record> getAttendant_By_CompanyUuid(string pCompanyUuid,string pKeyword,bool pIsActive,OrderLimit orderlimit)
        {
            try
            {
                dbc = IST.Config.DataBase.Factory.getInfo();
                CISR.Controller.Model.Basic.Table.Attendant attendant = new CISR.Controller.Model.Basic.Table.Attendant(dbc);
                var sc = new SQLCondition(attendant)
                .Equal(attendant.COMPANY_UUID, pCompanyUuid)
                .And()
                .Equal(attendant.IS_ACTIVE, pIsActive ? "Y" : "N");

                if (pKeyword.Trim().Length > 0) {
                    sc.L()
                        .iBLike(attendant.C_NAME, pKeyword)
                        .Or()
                        .iBLike(attendant.E_NAME, pKeyword)
                        .Or()
                        .iBLike(attendant.ACCOUNT, pKeyword)
                        .Or()
                        .iBLike(attendant.EMAIL, pKeyword)
                        .Or()
                        .iBLike(attendant.ID, pKeyword)                        
                     .R();

                }
                var result = attendant.Where(sc)
                .Limit(orderlimit)
                .FetchAll<Attendant_Record>();
                return result;
            }
        ...
        public Int32 getAttendant_By_CompanyUuid_Count(string pCompanyUuid, string pKeyword, bool pIsActive)
        {
            try
            {
                dbc = IST.Config.DataBase.Factory.getInfo();
        ...
        public IList<CISR.Controller.Model.Basic.Table.Record.AttendantV_Record> getAttendantV_By_Company_Account_Password(string pCompanyName, string pAccount, string pPassword)
        {
            try
            {
                dbc = IST.Config.DataBase.Factory.getInfo();
        ...
        public IList<CISR.Controller.Model.Basic.Table.Record.AttendantV_Record> getAttendantV_By_Company_Account_Password(string pCompanyName, string pAccount)
        {
            try
            {
                dbc = IST.Config.DataBase.Factory.getInfo();
        ...
        public System.Data.DataTable getDepartment_By_ParentUuid(string pParentUuid)
        {
            try
            {
                ...
                var result = department.Where(new SQLCondition(department)
                    ...
                    .FetchAll();
                //.FetchAll<CISR.Controller.Model.Basic.Table.Record.Department_Record>();
                return result;
            }
            catch (Exception ex)
            {
        ...
        public Int32 getGroupHead_ByParam_Count(string company_uuid, string application_head_uuid, List<string> group_head_list, string searchkey)
        {
            ...
            {
                dbc = IST.Config.DataBase.Factory.getInfo();
                CISR.Controller.Model.Basic.Table.GroupHeadV table = new CISR.Controller.Model.Basic.Table.GroupHeadV(dbc);
        ...
        public IList<GroupAttendantV_Record> getGroupAttendantBy(string application_head_uuid, string company_uuid, string attendant_uuid)
        {
            ...
            {
                dbc = IST.Config.DataBase.Factory.getInfo();
                CISR.Controller.Model.Basic.Table.GroupAttendantV table = new CISR.Controller.Model.Basic.Table.GroupAttendantV(dbc);
        ...
        public IList<GroupAttendant_Record> getGroupAttendantByGroupHeadUuid(string group_head_uuid)
        {
            ...
            {
                dbc = IST.Config.DataBase.Factory.getInfo();
                CISR.Controller.Model.Basic.Table.GroupAttendant table = new CISR.Controller.Model.Basic.Table.GroupAttendant(dbc);
        ...
        public System.Data.DataTable getAppmenuV_By_ParentUuid_DataTable(string pParentUuid)
        {
            ...
            {
                dbc = IST.Config.DataBase.Factory.getInfo();
                CISR.Controller.Model.Basic.Table.AppmenuApppageV appmenuv =
                    new CISR.Controller.Model.Basic.Table.AppmenuApppageV(dbc);
        ...
        public IList<Appmenu_Record> getAppmenu_By_ParentUuid_DataTable(string pParentUuid)
        {
            ...
            {
                dbc = IST.Config.DataBase.Factory.getInfo();
                CISR.Controller.Model.Basic.Table.Appmenu appmenuv =
                    new CISR.Controller.Model.Basic.Table.Appmenu(dbc);
                SQLCondition con = new SQLCondition(appmenuv)
                    .Equal(appmenuv.APPMENU_UUID, pParentUuid);
                OrderLimit order = new OrderLimit(appmenuv.NAME_ZH_TW, OrderLimit.OrderMethod.ASC);
                var result = appmenuv.Where(con)
        ...
        public IList<AppmenuApppageV_Record> getAppmenuV_Root_By_ApplicationHead(string pApplicationHeadUuid)
        {
            ...
            {
                dbc = IST.Config.DataBase.Factory.getInfo();
                CISR.Controller.Model.Basic.Table.AppmenuApppageV appmenuv = new CISR.Controller.Model.Basic.Table.AppmenuApppageV(dbc);
            ...
            (string pAppmenuUuid, string pGroupHeadUuid)
        {
            ...
            {
                dbc = IST.Config.DataBase.Factory.getInfo();
                CISR.Controller.Model.Basic.Table.GroupAppmenu groupAppMenuv = new CISR.Controller.Model.Basic.Table.GroupAppmenu(dbc);
                var result = groupAppMenuv.Where(new SQLCondition(groupAppMenuv)
                    .Equal(groupAppMenuv.GROUP_HEAD_UUID, pGroupHeadUuid)
                    .And()
        ...
        {
            dbc = IST.Config.DataBase.Factory.getInfo();
            CISR.Controller.Model.Basic.Table.AuthorityMenuV table = new CISR.Controller.Model.Basic.Table.AuthorityMenuV(dbc);
        ...
        {
            dbc = IST.Config.DataBase.Factory.getInfo();
            CISR.Controller.Model.Basic.Table.ErrorLogV table = new CISR.Controller.Model.Basic.Table.ErrorLogV(dbc);
            SQLCondition con = new SQLCondition(table)
        ...
        {
            dbc = IST.Config.DataBase.Factory.getInfo();
            CISR.Controller.Model.Basic.Table.ErrorLog table = new CISR.Controller.Model.Basic.Table.ErrorLog(dbc);
            SQLCondition con = new SQLCondition(table)
                .Equal(table.IS_READ, is_read);
        ...
        public int getVAppmenuProxyMap_Count(string pApplicationHeadUuid, string pAppmenuUuid, string pKeyWord)
        {
            ...
            {
                dbc = IST.Config.DataBase.Factory.getInfo();
                CISR.Controller.Model.Basic.Table.VAppmenuProxyMap table = new CISR.Controller.Model.Basic.Table.VAppmenuProxyMap(dbc);
        ...
        public IList<VAuthProxy_Record> getVAuthProxy_By_AttendantUuid(string pAttendantUuid)
        {
            ...
            {
                dbc = IST.Config.DataBase.Factory.getInfo();
                CISR.Controller.Model.Basic.Table.VAuthProxy vauthproxy = new CISR.Controller.Model.Basic.Table.VAuthProxy(dbc);
        ...
        public System.Data.DataTable getFrameHead_By_RootUuid_DataTable(string pRootUuid)
        {
            try
            {
                dbc = IST.Config.DataBase.Factory.getInfo();
                ...
                var result = framehead.Where(new SQLCondition(framehead)
                    .Equal(framehead.PARENT_FRAME_HEAD_UUID, pRootUuid)
                )
                .OrderASC(framehead.ORD)                
                .FetchAll();
                return result;
            }
            catch (Exception ex)
        ...
        public IList<FrameHead_Record> getFrameHead_By_CompanyUuid(string pCompanyUuid, OrderLimit orderlimit)
        {
            try
            {
                dbc = IST.Config.DataBase.Factory.getInfo();
        ...
        public int getFrameHead_By_CompanyUuid_Count(string pCompanyUuid)
        {
            try
            {
                dbc = IST.Config.DataBase.Factory.getInfo();
        ...
        public IList<FrameHead_Record> getFrameHead_By_CompanyUuid_Dlevel(string pCompanyUuid,int dlevel)
        {
            try
            {
                dbc = IST.Config.DataBase.Factory.getInfo();
                FrameHead framehead = new FrameHead(dbc);
                var result = framehead.Where(new SQLCondition(framehead)
                .Equal(framehead.COMPANY_UUID, pCompanyUuid).And()
                .Equal(framehead.DLEVEL,dlevel)
                )
        ...
        public IList<FrameHead_Record> getFrameHead_Root_By_CompanyUuid(string pCompanyUuid)
        {
            try
            {
                dbc = IST.Config.DataBase.Factory.getInfo();
        ...
        public IList<FrameHead_Record> getFrameHead_By_RootUuid(string pRootUuid)
        {
            try
            {
                dbc = IST.Config.DataBase.Factory.getInfo();
        ...
        public IList<FrameHead_Record> getFrameHead_By_Uuid(string pUuid)
        {
            try
            {
                dbc = IST.Config.DataBase.Factory.getInfo();
        ...
        public IList<FrameHead_Record> getFrameHead_By_RootUuid_FrameCategoryUuid(string pRootUuid,string pFrameCategoryUuid)
        {
            try
            {
                dbc = IST.Config.DataBase.Factory.getInfo();
                ...
                var result = framehead.Where(new SQLCondition(framehead)
                    .Equal(framehead.PARENT_FRAME_HEAD_UUID, pRootUuid)
                    .And()
                    .Equal(framehead.FRAME_CATEGORY_UUID,pFrameCategoryUuid)
                )
                .OrderASC(framehead.ORD)
                .FetchAll<FrameHead_Record>();
                return result;
