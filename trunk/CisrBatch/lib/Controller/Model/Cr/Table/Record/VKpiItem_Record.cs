...
namespace CISR.Model.Cr.Table.Record
{
	...
	[ISTDataBase("CISR")]
	[Serializable]
	public class VKpiItem_Record : RecordBase{
		public VKpiItem_Record(){}
		/*欄位資訊 Start*/
		...
		public VKpiItem_Record Clone(){
			try{
				return this.Clone<VKpiItem_Record>(this);
			}
			catch (Exception ex){
		...
		public VKpiItem gotoTable(){
			try{
				var dbc = IST.Config.DataBase.Factory.getInfo();
				VKpiItem ret = new VKpiItem(dbc,this);
				return ret;
			}
			catch (Exception ex){
				log.Error(ex);IST.MyException.MyException.Error(this, ex);
