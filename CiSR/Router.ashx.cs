...
namespace CISR
{
    ...
    public class Router : IHttpHandler, IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            string INIT = "";
            IList<CISR.Controller.Model.Basic.Table.Record.Proxy_Record> allProxy = new List<CISR.Controller.Model.Basic.Table.Record.Proxy_Record>();
            if (context.Request.QueryString["init"] != null)
            {
                allProxy = mod.getProxy_By_KeyWord(CISR.Parameter.Config.ParemterConfigs.GetConfig().InitAppUuid, "", null);
            }
