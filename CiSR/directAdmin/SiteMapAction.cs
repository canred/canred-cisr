...
public class SiteMapAction : BaseAction
{
    ...
    public JObject loadSiteMapTree(string parentUuid, Request request)
    {
        ...
        {    /*Cloud身份檢查*/
            ...
            /*取得資料*/
            var genTable = new CISR.Controller.Model.Basic.Table.SitemapV();
    ...
    public JObject loadThisApplication(string pApplicationHeadUuid, string pIsActive, string pageNo, string limitNo, string sort, string dir, Request request)
    {
        ...
        {  /*Cloud身份檢查*/
            ...
            string appName = CISR.Parameter.Config.ParemterConfigs.GetConfig().AppName;
            ApplicationHead tb = new ApplicationHead(IST.Config.DataBase.Factory.getInfo());
            var drs = tb.Where(new IST.DB.SQLCondition(tb).Equal(tb.NAME, appName))
                                        ...
                                        HttpRequest request)
    {
        ...
        {  /*Cloud身份檢查*/
            ...
            else
            {
                ...
                drAppPage.UUID = IST.Util.UID.Instance.GetUniqueID();
    ...
    public JObject addSiteMap(string pParentUuid, string pAppPageUuid, Request request)
    {
        ...
        { /*Cloud身份檢查*/
            ...
            if (dtSitemap.AllRecord().Count > 0)
            {
                ...
                drChildSitemap.UUID = IST.Util.UID.Instance.GetUniqueID();
