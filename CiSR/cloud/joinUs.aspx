<%@ Page Title="" Language="C#" MasterPageFile="~/mpStand.Master" AutoEventWireup="true" CodeBehind="joinUs.aspx.cs" Inherits="CISR.cloud.joinUs" %>
							...
							items:[
								{
									...
									items : [{
										...
										flex:1,	
										id:'txtServerWebUrl',
										value:'http://127.0.0.1/WebTemplate3',									
										emptyText:'http://127.0.0.1/WebTemplate3'
									},{
										xtype:'button',
