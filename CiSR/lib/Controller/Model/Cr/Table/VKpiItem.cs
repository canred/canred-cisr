...
{
	[ISTDataBase("CISR")]
	[ISTTableView("V_KPI_ITEM", false)]
	public partial class VKpiItem : TableBase{
	/*固定物件*/
	//IST.DB.SQLCreater.ASQLCreater sqlCreater = null;
	/*固定物件但名稱需更新*/
	private VKpiItem_Record _currentRecord = null;
	private IList<VKpiItem_Record> _All_Record = new List<VKpiItem_Record>();
		/*建構子*/
		public VKpiItem(){}
		public VKpiItem(IDataBaseConfigInfo dbc,string db): base(dbc,db){}
		public VKpiItem(IDataBaseConfigInfo dbc): base(dbc){}
		public VKpiItem(IDataBaseConfigInfo dbc,VKpiItem_Record currenData){
			this.setDataBaseConfigInfo(dbc);
			this._currentRecord = currenData;
		}
		public VKpiItem(IList<VKpiItem_Record> currenData){
		...
		/*欄位資訊 End*/
		/*固定的方法，但名稱需變更 Start*/
		public VKpiItem_Record CurrentRecord(){
			try{
		...
		public VKpiItem_Record CreateNew(){
			try{
				VKpiItem_Record newData = new VKpiItem_Record();
				return newData;
			}
			catch (Exception ex){
				log.Error(ex);IST.MyException.MyException.Error(this, ex);
		...
		public IList<VKpiItem_Record> AllRecord(){
			try{
				return _All_Record;
			}
			catch (Exception ex){
		...
		public void RemoveAllRecord(){
			try{
				_All_Record = new List<VKpiItem_Record>();
			}
			catch (Exception ex){
				log.Error(ex);IST.MyException.MyException.Error(this, ex);
				throw ex;
