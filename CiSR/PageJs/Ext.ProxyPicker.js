    ...
    Ext.define('ProxyPicker', {
                ...
                items: [
                    {
                        ...
                        items: [{
                            ...
                            itemId: 'btnQuery',
                            handler: function() {
                                storeProxy.getProxy().setExtraParam('pKeyword', Ext.getCmp('Ext_ProxyPicker_keyWork').getValue());
        ...
        listeners: {
            'show': function() {
                ...
                Ext.getCmp('Ext_ProxyPicker_Form').getForm().reset();
