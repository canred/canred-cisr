...
Ext.onReady(function() {
    ...
    var simple = Ext.widget({
        ...
        id: 'systemInfoForm',
        frame: true,
        title: '<img src="' + SYSTEM_ROOT_PATH + '/css/custimages/contact2.gif" style="height:16px;margin-bottom:8px;" align="middle">  係統連聯人員',
        bodyPadding: '5 5 5 5',
        width: 200,
        fieldDefaults: {
            msgTarget: 'side',
        ...
        defaultType: 'label',
        items: [{
            html: '<img src="' + SYSTEM_ROOT_PATH + '/css/custimages/app.gif" style="height:16px;margin-bottom:6px;" align="middle">係統相關'
        }, {
