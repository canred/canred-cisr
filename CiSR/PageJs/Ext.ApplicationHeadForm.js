    ...
    Ext.define('ApplicationHeadForm', {
        ...
        initComponent: function() {
            ...
            me.items = [Ext.create('Ext.form.Panel', {
                ...
                id: 'Ext_ApplicationHeadForm_Form',
                paramOrder: ['pUuid'],
                border: true,
                bodyPadding: 5,
                ...
                fbar: [{
                    ...
                    handler: function() {
                        var form = Ext.getCmp('Ext_ApplicationHeadForm_Form').getForm();
                        ...
                        form.submit({
                            ...
                            success: function(form, jsonObj) {
                                ...
                                Ext.getCmp('ApplicationHeadForm_UUID').setValue(jsonObj.result.UUID);
                                Ext.getCmp('ExtApplicationHeadForm').setTitle('係統【維護】');
        ...
        listeners: {
            'show': function() {
                ...
                if (this.uuid != undefined) {
                    ...
                    Ext.getCmp('Ext_ApplicationHeadForm_Form').getForm().load({
                        params: {
                            'pUuid': this.uuid
                        },
                    ...
                    /*When 新增資料*/
                    Ext.getCmp('ID').setDisabled(false);
                    Ext.getCmp('Ext_ApplicationHeadForm_Form').getForm().reset();
                }
            },
            'hide': function() {
                Ext.getBody().unmask();
