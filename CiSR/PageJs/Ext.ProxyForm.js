        ...
        initComponent: function() {
            ...
            me.items = [Ext.create('Ext.form.Panel', {
                ...
                items: [
                    {
                        ...
                        store: Ext.create('Ext.data.Store', {
                            ...
                            autoLoad: true,
                            model: Ext.define('MODAPPLICATION', {
                ...
                fbar: [{
                    ...
                    handler: function() {
                        var form = Ext.getCmp('Ext_ProxyForm_Form').getForm();
                        ...
                        form.submit({
                            ...
                            success: function(form, action) {
                                ...
                                Ext.getCmp('ProxyForm_UUID').setValue(action.result.UUID);
                    ...
                    handler: function() {
                        ...
                        Ext.MessageBox.show({
                            ...
                            fn: function(btn) {
                                if (btn == 'yes') {
                                    WS.ProxyAction.destroyProxyByUuid(Ext.getCmp('ProxyForm_UUID').getValue(), function(obj, a) {
        ...
        listeners: {
            'show': function() {
                ...
                if (this.uuid != undefined) {
                    ...
                    Ext.getCmp('Ext_ProxyForm_Form').getForm().load({
                        params: {
                            'pUuid': this.uuid
                        },
                    ...
                    Ext.getCmp('Ext_ProxyForm_Form').getForm().reset();
                }
            },
            'hide': function() {
                Ext.getBody().unmask();
