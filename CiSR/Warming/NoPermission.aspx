<%@ Page Title="" Language="C#" MasterPageFile="~/mpStand.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="CISR.Default" %>
...
<script language="javascript" type="text/javascript">
    ...
    Ext.onReady(function() {
        ...
        ExtNoPermission.logonUrl = '<%= Page.ResolveUrl(CISR.Parameter.Config.ParemterConfigs.GetConfig().LogonPage) %>';
