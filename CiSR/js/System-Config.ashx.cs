...
namespace CISR.js
{
    ...
    public class System_Config : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (systemConfig == null || CISR.Parameter.Config.ParemterConfigs.GetConfig().IsProductionServer == false)
            {
                ...
                srJs.Close();
                jsContext += "SYSTEM_APPLICATION='" + CISR.Parameter.Config.ParemterConfigs.GetConfig().DirectApplicationName + "';";
