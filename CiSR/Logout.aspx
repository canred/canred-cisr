<%@ Page Title="" Language="C#" MasterPageFile="~/mpStand.Master" AutoEventWireup="true" CodeBehind="Logout.aspx.cs" Inherits="CISR.Logout" EnableViewState="false"  %>
    ...
    ExtLogout = Ext.widget({
        ...
        items: [{
            ...
            items: [{
                ...
                flex: 1,
                handler: function () {
                    location.href = '<%= Page.ResolveUrl(CISR.Parameter.Config.ParemterConfigs.GetConfig().LogonPage) %>';
                }
            }, {
                xtype: 'label',
                flex: 1
