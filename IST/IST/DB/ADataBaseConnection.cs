...
namespace IST.DB
{
    public abstract class ADataBaseConnection :IDisposable
    {
        ...
        public void setDataBase(string dbName) {
            try
            {
                ...
                if (whereType.ToUpper() == "WS")
                {
                    ...
                    connectionString = IST.Util.Encrypt.pwdDecode(connectionString);
                    client = null;
                }
        ...
        public IDbDataParameter getDataParameter(IST.DB.SQLCreater.ISQLCreater pSqlCreater, string pName,object pValue,ParameterDirection pdirection) {
